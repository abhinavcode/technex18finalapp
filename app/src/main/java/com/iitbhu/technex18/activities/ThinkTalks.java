...
import com.iitbhu.technex18.fragments.ThinkTalkDetailFragment;
import com.iitbhu.technex18.fragments.ThinkTalkListFragment;
import com.iitbhu.technex18.utils.BoldModTextView;

import java.util.ArrayList;

public class ThinkTalks extends AppCompatActivity implements DbConstants, NavigationView.OnNavigationItemSelectedListener {
    ...
    private String ACTIVITY_NAME = "Think Talks";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.getViewPager().setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                switch (position) {
                    case 0:
                        return ThinkTalkListFragment.newInstance();
                    default:
                        return ThinkTalkDetailFragment.newInstance(position);
                }
            }
