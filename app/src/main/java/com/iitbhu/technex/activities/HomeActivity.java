...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, Constants {
    ...
    FloatingActionButton youtube,twitter,facebook,insta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youtube= (FloatingActionButton) findViewById(R.id.fabyoutube);
        twitter= (FloatingActionButton) findViewById(R.id.fabtwitter);
        facebook= (FloatingActionButton) findViewById(R.id.fabfb);
        insta= (FloatingActionButton) findViewById(R.id.fabinsta);
        youtube.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "http://www.youtube.com/technexiitbhu";
        ...
        insta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "http://www.instagram.com/technexiitbhu";
        ...
        facebook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "http://www.facebook.com/technexiitbhu";
        ...
        twitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = "http://www.twitter.com/technexiitbhu";
